...
from tools.utils import init_train_env, init_model
...
if fine_tune:
    start_epoch,learning_rate=init_model(parm,dataset_name,encoders,decoders,os.path.abspath("."))
else:
...
encoder_lr_scheduler=torch.optim.lr_scheduler.StepLR(
    encodersOptimizer,step_size=learning_rate_weaken_epoch__interval,gamma=learning_rate_weaken_rate)
decoder_lr_scheduler=torch.optim.lr_scheduler.StepLR(
    decodersOptimizer,step_size=learning_rate_weaken_epoch__interval,gamma=learning_rate_weaken_rate)
